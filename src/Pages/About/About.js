...
const About = () => {
    return (
        <div className='d-flex mt-5 p-5'>
            <div>
                <img className='w-100' src="https://media-exp1.licdn.com/dms/image/C5616AQH0hI_xTkmsng/profile-displaybackgroundimage-shrink_350_1400/0/1641278643229?e=2147483647&v=beta&t=FpdIxK37PXB06UEPK3L8LMiz_BH98tDrwlQDJjPOv4o" alt="" />
            </div>
            <div>
